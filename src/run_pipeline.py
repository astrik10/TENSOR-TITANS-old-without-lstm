...
from src.models import predict, save_models, train_models
        ...
        while True:
            ...
            for tick in new_ticks:
                ...
                print(
                    ...
                    f"pred(logreg={predictions['logreg']}, rf={predictions['random_forest']}) "
                    f"acc(logreg={acc_logreg:.3f}, rf={acc_rf:.3f}) "
